      ...
      >
        ...
        <div className="about-content">
          ...
          >
            ...
            <p>
              <strong>@digitaldefiance/i18n-lib</strong> embodies this
              mission by providing a production-ready internationalization library
              that handles all complexities of multi-language support.
              With ICU MessageFormat, 37 language support, CLDR-compliant plural rules,
              advanced number formatting, and comprehensive security hardening, we've
              created a library that eliminates weeks of i18n development
              and lets you focus on building features, not translation infrastructure.
            </p>
            <p className="highlight-text">
              <FaCode /> <strong>100% Open Source.</strong> This library is
              freely available under the MIT License and provides production-ready
              internationalization for TypeScript applications.
            </p>
          </motion.div>
          ...
          <div className="about-features">
            ...
            >
              ...
              <p>
                1,738 tests with 93.22% coverage, comprehensive security hardening, and
