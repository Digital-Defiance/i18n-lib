...
export const mandarinStrings: Record<CoreStringKey, string> = {
  ...
  [CoreStringKey.Error_ComponentNotFoundTemplate]: '未找到组件 "{componentId}"',
  ...
  [CoreStringKey.Error_DuplicateComponentTemplate]:
    '组件 "{componentId}" 已注册',
  [CoreStringKey.Error_DuplicateLanguageTemplate]: '语言 "{languageId}" 已注册',
  ...
  [CoreStringKey.Error_InstanceAlreadyExistsTemplate]:
    "键为'{key}'的实例已存在",
  [CoreStringKey.Error_InstanceNotFoundTemplate]: "未找到键为'{key}'的实例",
