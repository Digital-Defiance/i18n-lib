...
import { I18nConfig, I18nContext, LanguageCodeCollection, LanguageContext, DefaultCurrencyCode } from './types';
...
const getConfig = <TConstants extends Record<string, any>, TTranslationContext extends string = LanguageContext>(constants: TConstants, timezone?: Timezone, adminTimezone?: Timezone): I18nConfig<StringKey, Language, TConstants, TTranslationContext> => ({
  strings: {
...
export const getDefaultI18nEngine = <TConstants extends Record<string, any>, TTranslationContext extends string, TContext extends I18nContext<DefaultLanguage, TTranslationContext>>(constants:TConstants, timezone?: Timezone, adminTimezone?: Timezone) => new I18nEngine<DefaultStringKey, DefaultLanguage, TConstants, TTranslationContext, TContext>(getConfig<TConstants, TTranslationContext>(constants, timezone, adminTimezone), 'user' as TTranslationContext);