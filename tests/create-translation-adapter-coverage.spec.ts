...
describe('createTranslationAdapter coverage', () => {
  ...
  beforeEach(() => {
    ...
    engine.registerComponent({
      component: { id: 'test-comp', name: 'Test', stringKeys: Object.values(TestStringKey) },
      strings: {
        'en-US': { [TestStringKey.Key1]: 'Value 1', [TestStringKey.Key2]: 'Value 2' },
        'en-GB': { [TestStringKey.Key1]: 'Value 1', [TestStringKey.Key2]: 'Value 2' },
        'fr': { [TestStringKey.Key1]: 'Value 1', [TestStringKey.Key2]: 'Value 2' },
        'es': { [TestStringKey.Key1]: 'Value 1', [TestStringKey.Key2]: 'Value 2' },
        'de': { [TestStringKey.Key1]: 'Value 1', [TestStringKey.Key2]: 'Value 2' },
        'zh-CN': { [TestStringKey.Key1]: 'Value 1', [TestStringKey.Key2]: 'Value 2' },
        'ja': { [TestStringKey.Key1]: 'Value 1', [TestStringKey.Key2]: 'Value 2' },
        'uk': { [TestStringKey.Key1]: 'Value 1', [TestStringKey.Key2]: 'Value 2' },
      },
    });
  });
  ...
  describe('translate method', () => {
    it('should handle 4-argument call (full TranslationEngine interface)', () => {
      ...
      const result = adapter.translate('test-comp', TestStringKey.Key1, {}, 'en-US');
  ...
  describe('safeTranslate method', () => {
    it('should handle 4-argument call (full TranslationEngine interface)', () => {
      const adapter = createTranslationAdapter(engine, 'test-comp');
      const result = adapter.safeTranslate('test-comp', TestStringKey.Key1, {}, 'en-US');
      expect(result).toBe('Value 1');
    });
