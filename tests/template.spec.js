...
(function (TestStrings) {
    ...
    TestStrings["UserGreeting"] = "userGreeting";
    TestStrings["UserGreetingTemplate"] = "userGreetingTemplate";
    TestStrings["AdminWelcomeTemplate"] = "adminWelcomeTemplate";
...
describe('template processing', () => {
    ...
    beforeEach(() => {
        translateFn = jest.fn();
        templateProcessor = (0, template_1.createTemplateProcessor)(TestStrings, translateFn, 'TestStrings');
    });
    describe('createTemplateProcessor', () => {
        ...
        it('should process template enum patterns with variables', () => {
            ...
            const result = templateProcessor('{{TestStrings.UserGreetingTemplate}}', TestLanguages.English, { name: 'John' });
        ...
        it('should process multiple enum patterns', () => {
            ...
            const result = templateProcessor('{{TestStrings.Simple}} and {{TestStrings.UserGreeting}}');
        ...
        it('should handle template patterns that need variables', () => {
            ...
            const result = templateProcessor('{{TestStrings.UserGreetingTemplate}} {{TestStrings.AdminWelcomeTemplate}}', TestLanguages.English, { name: 'John' }, { name: 'Jane', app: 'MyApp' });
            expect(translateFn).toHaveBeenCalledTimes(2);
        ...
        it('should handle non-template enum patterns without variables', () => {
            translateFn.mockReturnValue('Hello');
            const result = templateProcessor('{{TestStrings.Simple}}', TestLanguages.English, { name: 'John' });
        ...
        it('should replace remaining variables after enum processing', () => {
            translateFn.mockReturnValue('Hello');
            const result = templateProcessor('{{TestStrings.Simple}} {name}!', TestLanguages.English, { name: 'John' });
            expect(result).toBe('Hello John!');
        });
        it('should handle multiple variable objects', () => {
            const result = templateProcessor('Hello {firstName} {lastName}!', TestLanguages.English, { firstName: 'John' }, { lastName: 'Doe' });
            expect(result).toBe('Hello John Doe!');
        });
        it('should handle overlapping variables from multiple objects', () => {
            const result = templateProcessor('Hello {name}!', TestLanguages.English, { name: 'John' }, { name: 'Jane' } // This should override the first
            );
        ...
        it('should leave unmatched variables unchanged', () => {
            const result = templateProcessor('Hello {unknownVar}!', TestLanguages.English, { name: 'John' });
            expect(result).toBe('Hello {unknownVar}!');
        });
        it('should handle empty variable objects', () => {
            translateFn.mockReturnValue('Hello');
            const result = templateProcessor('{{TestStrings.Simple}} {name}!', TestLanguages.English, {}, {});
        ...
        it('should handle complex mixed patterns', () => {
            translateFn
                .mockReturnValueOnce('Welcome')
                .mockReturnValueOnce('Hello, John!');
            const result = templateProcessor('{{TestStrings.UserGreeting}} to {app}! {{TestStrings.UserGreetingTemplate}}', TestLanguages.English, { app: 'MyApp' }, { name: 'John' });
            expect(translateFn).toHaveBeenCalledTimes(2);
        ...
        it('should handle case-insensitive template detection', () => {
            ...
            const upperProcessor = (0, template_1.createTemplateProcessor)(upperCaseEnum, translateFn, 'TestStrings');
            const result = upperProcessor('{{TestStrings.UserGreetingTEMPLATE}}', TestLanguages.English, { name: 'John' });
            expect(translateFn).toHaveBeenCalledWith('userGreetingTEMPLATE', { name: 'John' }, TestLanguages.English);
            expect(result).toBe('Hello, John!');
        });
    });
